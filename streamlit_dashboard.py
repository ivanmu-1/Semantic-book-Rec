...
query = st.text_input("Please enter a description of a book:", "e.g., A story about forgiveness")
...
if st.button("Find recommendations"):
    with st.spinner("Fetching recommendations..."):
        ...
        for img_url, caption in results:
            st.image(img_url, caption=caption, width=150)